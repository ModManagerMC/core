...
package xyz.deathsgun.modmanager.core.gui
...
class ErrorScreen(
    ...
    override fun init() {
        ...
        addButton(ButtonWidget(
            this.width / 2 - 155, bottom, 150, 20, ScreenTexts.BACK
        ) {
            client!!.openScreen(previousScreen)
        })
        addButton(ButtonWidget(
            this.width / 2 + 5, bottom, 150, 20, TranslatableText("modmanager.button.tryAgain")
        ) {
